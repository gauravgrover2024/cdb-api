...
export const PERMISSION_CATALOG = [
  ...
  },
  {
    ...
    label: "Loans",
    sections: [
      { key: "customer", label: "Customer & KYC", fields: [["personalDetails", "Personal Details"], ["customerName", "Customer Name"], ["mobile", "Mobile Number"], ["email", "Email Address"], ["address", "Address"], ["panNumber", "PAN Number"], ["aadhaarNumber", "Aadhaar Number"], ["passportFront", "Passport Front"], ["passportBack", "Passport Back"], ["financialDetails", "Financial Details"], ["occupationDetails", "Occupation Details"], ["kycDetails", "KYC Details"], ["bankDetails", "Bank Details"], ["coApplicantDetails", "Co-Applicant Details"], ["guarantorDetails", "Guarantor Details"]] },
  ...
  },
  {
    ...
    label: "Home Loans",
    sections: [
      { key: "customer", label: "Customer & KYC", fields: [["personalDetails", "Personal Details"], ["customerName", "Customer Name"], ["mobile", "Mobile Number"], ["email", "Email Address"], ["address", "Address"], ["panNumber", "PAN Number"], ["aadhaarNumber", "Aadhaar Number"], ["passportFront", "Passport Front"], ["passportBack", "Passport Back"], ["incomeDetails", "Income Details"], ["occupationDetails", "Occupation Details"], ["kycDetails", "KYC Details"], ["bankDetails", "Bank Details"], ["coApplicantDetails", "Co-Applicant Details"], ["guarantorDetails", "Guarantor Details"]] },
