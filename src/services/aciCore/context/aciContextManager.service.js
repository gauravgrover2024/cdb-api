...
const compactVehicleContext = (vehicle = {}) => {
  ...
  return createEmptySelectedVehicleState({
    ...
    bodyType: cleanText(firstMeaningful(compact.bodyType, vehicle.bodyStyle, vehicle.segment)),
    seatingCapacity: firstMeaningful(compact.seatingCapacity, vehicle.seats),
    fuelTypes: unique(asArray(firstMeaningful(compact.fuelTypes, vehicle.availableFuels, vehicle.fuels))),
    transmissions: unique(asArray(firstMeaningful(compact.transmissions, vehicle.availableTransmissions))),
    priceBand: cleanText(firstMeaningful(compact.priceBand, vehicle.priceRange)),
    safetyFeatures: unique(asArray(firstMeaningful(compact.safetyFeatures, vehicle.knownSafetyFeatures))),
    featureHighlights: unique(asArray(firstMeaningful(compact.featureHighlights, vehicle.knownFeatureHighlights))),
    ownershipSignals: unique(asArray(firstMeaningful(compact.ownershipSignals, vehicle.serviceResaleOwnershipSignals))),
    similarAlternatives: asArray(firstMeaningful(compact.similarAlternatives, vehicle.alternatives)),
  ...
  return compactObject({
    ...
    selectedVehicle: hasVehicle
      ? compactObject({
          ...
          priceBand: vehicle.priceBand,
          safetyFeatures: vehicle.safetyFeatures,
          featureHighlights: vehicle.featureHighlights,
          ownershipSignals: vehicle.ownershipSignals,
