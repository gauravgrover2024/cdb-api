...
export const ACI_ANSWER_LANGUAGE_REGISTRY = Object.freeze({
  ...
  decision_buyer_guidance_practical_first_view: {
    ...
    requiredInputs: ['model', 'vehicleFactsLine', 'strengthsLine', 'watchoutsLine', 'fitLine', 'alternativeLine', 'upgradeLine', 'buyerContextLine', 'assumptionsLine', 'softQuestion'],
    tone: TONE,
    ...
    variants: [
      { id: 'buyer_guidance_practical_a', text: 'Based on the current evidence for {{model}}, here is a practical first view. Known facts: {{vehicleFactsLine}}. Strong signals I can see: {{strengthsLine}}. Watchouts: {{watchoutsLine}}. This fits best when: {{fitLine}}. Compare alternatives if: {{alternativeLine}}. For variant upgrade: {{upgradeLine}}. Buyer context I have: {{buyerContextLine}}. Assumption: {{assumptionsLine}}. One useful next question: {{softQuestion}}' },
      { id: 'buyer_guidance_practical_b', text: '{{model}} can be assessed with the facts and decision signals available so far. Known facts: {{vehicleFactsLine}}. Strong signals I can see: {{strengthsLine}}. Watchouts: {{watchoutsLine}}. This fits best when: {{fitLine}}. Compare alternatives if: {{alternativeLine}}. For variant upgrade: {{upgradeLine}}. Buyer context I have: {{buyerContextLine}}. Assumption: {{assumptionsLine}}. One useful next question: {{softQuestion}}' },
    ],
  },
  decision_buyer_guidance_conditional: {
    ...
    requiredInputs: ['model', 'vehicleFactsLine', 'strengthsLine', 'watchoutsLine', 'fitLine', 'alternativeLine', 'upgradeLine', 'assumptionsLine', 'softQuestion'],
    tone: TONE,
    guardrails: ['Use only supplied facts.', 'Label assumptions.', 'Ask at most one soft question.', 'Do not expose internal blocker wording.'],
    forbiddenWording: ['internal blocker wording', 'you should buy', 'buy this'],
    variants: [
      { id: 'buyer_guidance_conditional_a', text: 'Based on what I know so far about {{model}}, this is conditional guidance. Known facts: {{vehicleFactsLine}}. Strong signals I can see: {{strengthsLine}}. Watchouts: {{watchoutsLine}}. This fits best when: {{fitLine}}. Compare alternatives if: {{alternativeLine}}. For variant upgrade: {{upgradeLine}}. Assumption: {{assumptionsLine}}. One useful next question: {{softQuestion}}' },
      { id: 'buyer_guidance_conditional_b', text: 'I can give a useful provisional view for {{model}} from the evidence available. Known facts: {{vehicleFactsLine}}. Strong signals I can see: {{strengthsLine}}. Watchouts: {{watchoutsLine}}. This fits best when: {{fitLine}}. Compare alternatives if: {{alternativeLine}}. For variant upgrade: {{upgradeLine}}. Assumption: {{assumptionsLine}}. One useful next question: {{softQuestion}}' },
    ],
  },
  decision_buyer_guidance_sharpened_recommendation: {
    ...
    forbiddenWording: ['internal blocker wording', 'you should buy', 'buy this'],
    variants: [
      { id: 'buyer_guidance_sharpened_a', text: 'With your context, here is sharpened guidance for {{model}}. Known facts: {{vehicleFactsLine}}. Strong signals I can see: {{strengthsLine}}. Watchouts: {{watchoutsLine}}. This fits best when: {{fitLine}}. Compare alternatives if: {{alternativeLine}}. For variant upgrade: {{upgradeLine}}. Buyer context I have: {{buyerContextLine}}. Assumption: {{assumptionsLine}}. One useful next question: {{softQuestion}}' },
      { id: 'buyer_guidance_sharpened_b', text: 'Here is a sharper, still provisional view for {{model}}. Known facts: {{vehicleFactsLine}}. Strong signals I can see: {{strengthsLine}}. Watchouts: {{watchoutsLine}}. This fits best when: {{fitLine}}. Compare alternatives if: {{alternativeLine}}. For variant upgrade: {{upgradeLine}}. Buyer context I have: {{buyerContextLine}}. Assumption: {{assumptionsLine}}. One useful next question: {{softQuestion}}' },
    ],
  },
