const ACI_PROGRESS_MODULES = [
...

  {
    ...
    pending: "Continue long-tail unsupported-data and buyer-context capture coverage, then move to final blocked-readiness UX closure while keeping final recommendations disabled until buyer-context recommendation policy and composer are production-ready.",
    items: [
