const ACI_PROGRESS_MODULES = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "data_gap_queue", name: "Auditable data gap queue: 2,834 open gaps", status: "ready" },
