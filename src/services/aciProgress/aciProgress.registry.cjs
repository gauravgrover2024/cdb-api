const ACI_PROGRESS_MODULES = [
...

  {
    ...
    currentState: "Phase 0 is being implemented. Standalone Decision Policy / Eligibility constants, decision output contract, policy evaluator and smoke test skeleton now exist. Runtime score/similar/recommendation tools are not wired to the policy yet.",
