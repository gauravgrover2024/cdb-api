const ACI_PROGRESS_MODULES = [
  ...
  },
  {
    ...
    pending: "Complete score modules, feature explainer, recommendation/value/regret/safety scoring, crash safety confidence handling, ACI Assist score integration, and long-tail similar-cars expert audit. Similar cars graph/read model is built, buyer-quality repaired, policy-gated and wired into decision refresh. Mileage, dimensions and performance gaps are reviewed/closed; remaining data caveats are crash-rating gaps and upgrade-edge review.",
    items: [
...

  {
    ...
    done: "Core data foundation is materially cleaned: dimensions, performance and mileage gaps are closed/reviewed; city price overlays, decision profiles, gap queue discipline, and similar cars graph/read model refresh gating are in place.",
    pending: "Complete score engine, feature explainer, recommendations, upgrade ladder, crash confidence, ACI Assist integration, canvas contracts, CRM/leads, revenue, WhatsApp, SEO/indexing, eval hardening, and long-tail similar-cars expert audit.",
