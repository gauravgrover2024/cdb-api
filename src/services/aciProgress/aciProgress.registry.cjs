const ACI_PROGRESS_MODULES = [
  {
    ...
    pending: "Test guarded bridge through the portal UI before enabling beyond local/staging, complete module/capability registry, replace fragile old early-gate behavior, expand final-answer evals, and add complete trace/audit contract.",
    items: [
