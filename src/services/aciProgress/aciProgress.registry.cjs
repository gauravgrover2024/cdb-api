const ACI_PROGRESS_MODULES = [
...

  {
    ...
    pending: "Complete feature explainer, final recommendations, buyer-context score weighting, crash confidence, ACI Assist decision composer integration, canvas contracts, CRM/leads, revenue, WhatsApp, SEO/indexing, eval hardening, and long-tail similar-cars expert audit.",
