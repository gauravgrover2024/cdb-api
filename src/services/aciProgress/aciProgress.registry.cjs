const ACI_PROGRESS_MODULES = [
...

  {
    ...
    pending: "Next: Phase 5 Buyer Context + Decision Input Contract. Build structured buyer-context capture/reuse for city, budget, family/use case, running, fuel, transmission, safety, features and shortlist before enabling any final recommendation composer.",
    items: [
