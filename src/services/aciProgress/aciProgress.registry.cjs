const ACI_PROGRESS_MODULES = [
...

  {
    ...
    pending: "Continue centralizing remaining scattered decision wording, expand long-tail score/similar/final-intent audit coverage, strengthen no-data recovery wording, improve buyer-context capture, and keep final recommendations disabled until buyer-context recommendation policy and composer are production-ready.",
    items: [
